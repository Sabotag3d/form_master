...
function uploadStart(file) {
	try {
		...
		jQuery('#'+progressTargetContainer).closest('.element').find('.cfg-errormessage').hide().empty();
...
function uploadSuccess(file, serverData) {
	...
	var previousupload_filename = jQuery('#'+progressTargetContainer).closest('.cfg-option-container').find('.cfg-deleteupload-filename').val();
	...
	{	// the .cfg-deleteuploadedfile input can also be added when the delete link is clicked: contactform.js => $('body').on('click', '.cfg-deleteupload'
		jQuery('#'+progressTargetContainer).closest('.cfg-option-container').append('<input value="'+previousupload_filename+'" type="hidden" class="cfg-deleteuploadedfile" />');
	}
	...
	jQuery('#'+progressTargetContainer).closest('.cfg-option-container').find('.cfg-uploadfilename').val(json_upload_data['filename']);
